...
public class UploadAcademicRoutine extends AppCompatActivity {

    ImageView browseDoc, uploadDoc, backBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_academic_routine);

        //testing one
//        database = FirebaseDatabase.getInstance();
//        AdminId = FirebaseAuth.getInstance().getCurrentUser();
//        registerAdminID = AdminId.getUid();
//        databaseReference = database.getReference().child("AdminData").child(registerAdminID).child("Academics").child("AcademicRoutine");
//        storageReference = FirebaseStorage.getInstance().getReference();

        //right one
        storageReference = FirebaseStorage.getInstance().getReference();
        databaseReference = FirebaseDatabase.getInstance().getReference("Academics").child("AcademicRoutine");

        backBtn = findViewById(R.id.routineBackBtn);
        pdfTitle = findViewById(R.id.routineName_TextView);
        browseDoc = findViewById(R.id.routine_scan_Pdf);
        uploadDoc = findViewById(R.id.routine_upload_Pdf);
        cancelButton = findViewById(R.id.routine_cancel_btn);
        browseBtn = findViewById(R.id.routine_browse_Btn);
        uploadBtn = findViewById(R.id.routine_upload_btn);
    ...
    public void routineBackToPreviousPage(View view) {
    ...
    private void uploadProcess(Uri filepath) {
        ...
        StorageReference reference = storageReference.child("Academics/" + "Academic Routine/" + UUID.randomUUID().toString() + "-" + pdfName);
        reference.putFile(filepath)
                        ...
                        reference.getDownloadUrl()
                                .addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        UploadRoutineHelperClass data = new UploadRoutineHelperClass(pdfName, uri.toString());

                                        databaseReference.child(Objects.requireNonNull(databaseReference.push().getKey())).setValue(data);
                                        pd.dismiss();
                                        Toast.makeText(UploadAcademicRoutine.this, "File Uploaded", Toast.LENGTH_SHORT).show();
                                        uploadDoc.setVisibility(View.INVISIBLE);
                                        cancelButton.setVisibility(View.INVISIBLE);
                                        browseDoc.setVisibility(View.VISIBLE);
                                        pdfTitle.setText("");
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull @NotNull Exception e) {
                        Toast.makeText(UploadAcademicRoutine.this, "Error : " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    public void viewAcademicCalendar(View view) {
        startActivity(new Intent(getApplicationContext(), ViewAcademicRoutine.class));
    }
}